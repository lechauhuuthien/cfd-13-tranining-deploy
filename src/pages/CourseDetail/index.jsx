...
const CourseDetail = () => {
  ...
  // tạo ref
  const outlineSectionRef = useRef();

  const teacherRef = useRef();
  console.log("teacherRef", teacherRef);

  const scrollToOutline = () => {
    // Thực hiện scroll đến outlineSection
    // @ts-ignore
        ...
        <section className="contentdetail">
          <div className="content">
            <div className="container">
              ...
              <div className="contentrow ctlession" ref={outlineSectionRef}>
              ...
              <div className="contentrow ctrequest">
                <h3 className="contentrow__title title --t3" ref={teacherRef}>
                  Yêu cầu cần có
                </h3>
